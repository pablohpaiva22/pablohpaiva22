...
Minha principal atuação é no front-end, porém também possuo conhecimentos no back-end na criação de APIs com NodeJS junto com exress e MySQL como banco de dados.
